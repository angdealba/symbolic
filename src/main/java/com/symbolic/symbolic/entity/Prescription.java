...
/**
 * A data model for a prescription, representing its dosage, frequency,
 * cost, and usage instructions.
 */
@Entity
...
public class Prescription {
   ...
   *
   * @param dosage       an integer value representing the number of pills taken at a time
   * @param dailyUses    an integer value representing the number of times it should be taken daily
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(id, that.id) && Objects.equals(dosage, that.dosage)
        && Objects.equals(dailyUses, that.dailyUses) && Objects.equals(cost, that.cost)
        && Objects.equals(instructions, that.instructions) && Objects.equals(patient, that.patient)
